class Handler:
    # return a method named (prefix + name)
    ...
    # return a method whose name is ('sub_' + name)
    def sub(self, name):
...
class HTMLRenderer(Handler):
    ...
    def end_heading5(self):
        print '</h5>'
    def start_heading6(self):
        print '<h6>'
    def end_heading6(self):
        print '</h6>'
    # ---added
    ...
    def sub_highlight(self, match):
        return '<font color="#00DB00">%s</font>' % match.group(1)
